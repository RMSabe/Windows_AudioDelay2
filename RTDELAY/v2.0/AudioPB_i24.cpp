...
BOOL WINAPI AudioPB_i24::audio_hw_init(VOID)
{
	...
	this->BUFFERIN_SIZE_BYTES = (this->AUDIOBUFFER_SEGMENT_SIZE_SAMPLES)*(this->FILE_BYTES_PER_SAMPLE);
...
BOOL WINAPI AudioPB_i24::buffer_alloc(VOID)
{
	...
	{
		this->err_msg = TEXT("AudioPB_i24::buffer_alloc: Error: p_processheap is NULL.");
		return FALSE;
	}
	...
	{
		this->buffer_free();
		this->err_msg = TEXT("AudioPB_i24::buffer_alloc: Error: failed to allocate heap memory.");
		return FALSE;
	}
...
BOOL WINAPI AudioPB_i24::buffer_free(VOID)
{
	if(p_processheap == NULL)
	{
		this->err_msg = TEXT("AudioPB_i24::buffer_free: Error: p_processheap is NULL.");
		return FALSE;
	}
	...
	if(this->p_bufferinput != NULL)
	{
		...
		{
			this->err_msg = TEXT("AudioPB_i24::buffer_free: Error: failed to release heap memory.");
			return FALSE;
		}

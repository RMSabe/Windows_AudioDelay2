...
"C:\MinGW64\bin\g++.exe" AudioRTDelay.cpp -c -std=c++11 -m64 -o AudioRTDelay_64.o
...
"C:\MinGW64\bin\g++.exe" main_64.o globldef_64.o cstrdef_64.o thread_64.o strdef_64.o AudioRTDelay_64.o AudioPB_64.o AudioPB_i16_64.o AudioPB_i24_64.o -lole32 -lcomctl32 -lksuser -mwindows -m64 -o delay64.exe

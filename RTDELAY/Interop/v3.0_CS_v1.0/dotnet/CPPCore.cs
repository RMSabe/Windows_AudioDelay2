...
public static class CPPCore
{
	...
	public const int STATUS_ERROR_MEMORY = -4;
	public const int STATUS_ERROR_AUDIOHW = -3;
	public const int STATUS_ERROR_NOFILE = -2;
	public const int STATUS_ERROR_GENERIC = -1;
	public const int STATUS_UNINITIALIZED = 0;
	public const int STATUS_READY = 1;
	public const int STATUS_PLAYING = 2;
	public const int STATUS_PAUSED = 3;
	public const int STATUS_STOPPED = 4;

	public const uint RTDELAY_BUFFER_SIZE_FRAMES = 65536U;
	...
	[DllImport(LIBCORE_DIR, CallingConvention = CallingConvention.StdCall)] public static extern Int32 GetStatus();
	...
	[DllImport(LIBCORE_DIR, CallingConvention = CallingConvention.StdCall)] public static extern void PausePlayback();
	[DllImport(LIBCORE_DIR, CallingConvention = CallingConvention.StdCall)] public static extern void ResumePlayback();
	[DllImport(LIBCORE_DIR, CallingConvention = CallingConvention.StdCall)] public static extern void StopPlayback();
	[DllImport(LIBCORE_DIR, CallingConvention = CallingConvention.StdCall)] public static extern Int64 GetAudioDataSizeFrames();
	[DllImport(LIBCORE_DIR, CallingConvention = CallingConvention.StdCall)] public static extern Int64 GetAudioDataPositionFrames();
	[DllImport(LIBCORE_DIR, CallingConvention = CallingConvention.StdCall)] public static extern Int32 SetAudioDataPositionFrames(UInt64 position);

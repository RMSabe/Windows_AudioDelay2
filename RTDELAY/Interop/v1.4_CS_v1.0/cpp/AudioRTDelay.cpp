...
BOOL WINAPI AudioRTDelay::buffer_alloc(VOID)
{
	...
	{
		this->err_msg = TEXT("AudioRTDelay::buffer_alloc: Error: p_processheap is NULL.");
		return FALSE;
	}
...
BOOL WINAPI AudioRTDelay::buffer_free(VOID)
{
	if(p_processheap == NULL)
	{
		this->err_msg = TEXT("AudioRTDelay::buffer_free: Error: p_processheap is NULL.");
		return FALSE;
	}
...
BOOL WINAPI AudioRTDelay::buffer_fxparams_alloc(VOID)
{
	...
	if(p_processheap == NULL)
	{
		this->err_msg = TEXT("AudioRTDelay::buffer_fxparams_alloc: Error: p_processheap is NULL.");
		return FALSE;
	}
...
BOOL WINAPI AudioRTDelay::buffer_fxparams_free(VOID)
{
	if(p_processheap == NULL)
	{
		this->err_msg = TEXT("AudioRTDelay::buffer_fxparams_free: Error: p_processheap is NULL.");
		return FALSE;
	}

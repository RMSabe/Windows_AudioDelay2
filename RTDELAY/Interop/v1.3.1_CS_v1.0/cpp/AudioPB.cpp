...
BOOL WINAPI AudioPB::audiodevicelist_alloc(VOID)
{
	...
	{
		this->err_msg = TEXT("AudioPB::audiodevicelist_alloc: Error: failed to retrieve process heap.");
		return FALSE;
	}
...
BOOL WINAPI AudioPB::audiodevicelist_free(VOID)
{
	...
	if(p_processheap == NULL)
	{
		this->err_msg = TEXT("AudioPB::audiodevicelist_free: Error: failed to retrieve process heap.");
		return FALSE;
	}

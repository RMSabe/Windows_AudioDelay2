...
"C:\MinGW64\bin\g++.exe" main_32.o globldef_32.o cstrdef_32.o thread_32.o strdef_32.o AudioRTDelay_32.o AudioPB_32.o AudioPB_i16_32.o AudioPB_i24_32.o -lole32 -lksuser -mwindows -m32 -o delay32.exe

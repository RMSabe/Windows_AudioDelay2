...
BOOL WINAPI AudioPB_i16::buffer_alloc(VOID)
{
	...
	{
		this->err_msg = TEXT("AudioPB_i16::buffer_alloc: Error: failed to retrieve process heap.");
		return FALSE;
	}
...
BOOL WINAPI AudioPB_i16::buffer_free(VOID)
{
	...
	if(p_processheap == NULL)
	{
		this->err_msg = TEXT("AudioPB_i16::buffer_free: Error: failed to retrieve process heap.");
		return FALSE;
	}

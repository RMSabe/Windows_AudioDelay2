...
extern LONG_PTR WINAPI listbox_add_item(HWND p_listbox, const TCHAR *text);
extern LONG_PTR WINAPI listbox_remove_item(HWND p_listbox, ULONG_PTR index);
extern LONG_PTR WINAPI listbox_get_item_count(HWND p_listbox);
extern LONG_PTR WINAPI listbox_get_sel_index(HWND p_listbox);

extern VOID WINAPI fxparams_text_update(VOID);

extern BOOL WINAPI attempt_update_param(HWND p_textbox, INT param);
...
BOOL WINAPI attempt_update_param(HWND p_textbox, INT param)
{
	LONG_PTR n_fx;
	ULONG_PTR i_val;
	FLOAT f_val;
